...
$url_linkedin = get_field('url_linkedin', 'option');
$url_youtube = get_field('url_youtube', 'option');
$telefone_capitais = get_field('telefone_capitais', 'option');
$telefone_outras_localidades = get_field('telefone_outras_localidades', 'option');
$email_suporte = get_field('email_suporte', 'option');
$horario_de_funcionamento = get_field('horario_de_funcionamento', 'option');
?>
<footer class="footer">
  <div class="container">
    <div class="row">
